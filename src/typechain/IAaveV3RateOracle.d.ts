...
interface IAaveV3RateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class IAaveV3RateOracle extends BaseContract {
  ...
  interface: IAaveV3RateOracleInterface;
