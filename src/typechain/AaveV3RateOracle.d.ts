...
interface AaveV3RateOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class AaveV3RateOracle extends BaseContract {
  ...
  interface: AaveV3RateOracleInterface;
