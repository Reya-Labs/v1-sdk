...
import type {
  IAaveV3RateOracle,
  IAaveV3RateOracleInterface,
} from "../IAaveV3RateOracle";
...
export class IAaveV3RateOracle__factory {
  static readonly abi = _abi;
  static createInterface(): IAaveV3RateOracleInterface {
    return new utils.Interface(_abi) as IAaveV3RateOracleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAaveV3RateOracle {
    return new Contract(address, _abi, signerOrProvider) as IAaveV3RateOracle;
  }
}
