...
interface GlpRateOracleInterface extends ethers.utils.Interface {
  functions: {
    ...
    "lastCumulativeRewardPerToken()": FunctionFragment;
    "lastEthPriceInGlp()": FunctionFragment;
    "lastUpdatedBlock()": FunctionFragment;
    "minSecondsSinceLastUpdate()": FunctionFragment;
    "observations(uint256)": FunctionFragment;
    "oracleVars()": FunctionFragment;
    "owner()": FunctionFragment;
    "refreshRewardContracts()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "lastCumulativeRewardPerToken",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "lastEthPriceInGlp",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "refreshRewardContracts",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class GlpRateOracle extends BaseContract {
  ...
  interface: GlpRateOracleInterface;
  ...
  functions: {
    ...
    lastEthPriceInGlp(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  lastCumulativeRewardPerToken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    refreshRewardContracts(overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    lastEthPriceInGlp(overrides?: CallOverrides): Promise<PopulatedTransaction>;
