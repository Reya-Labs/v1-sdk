...
export interface CommunitySBTInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [CommunitySBT.LeafInfoStruct, PromiseOrValue<BytesLike>[], PromiseOrValue<BytesLike>],
  ): string;
...
export type InvalidatedRootEvent = TypedEvent<[string], InvalidatedRootEventObject>;
